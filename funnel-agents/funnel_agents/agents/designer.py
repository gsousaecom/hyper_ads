...
class Designer(Agent):
    ...
    system_prompt = (
        ...
        "- Preserve os marcadores [VALIDAR: ...] da copy no HTML, visíveis "
        "e destacados (ex.: fundo amarelo), para o dono da página saber o "
        "que substituir por provas reais antes de publicar.\n"
